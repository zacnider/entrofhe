...
const SIMPLE_LOTTERY_ADDRESS = process.env.REACT_APP_SIMPLE_LOTTERY_ADDRESS || '0x61EED5e30c1E92ca78Fee563e2CA61E3217643F2';
const RANDOM_NUMBER_GENERATOR_ADDRESS = process.env.REACT_APP_RANDOM_NUMBER_GENERATOR_ADDRESS || '0xb840c862e553BBB489a421e9d3B9b9AF00C16051';
const ENTROPY_NFT_ADDRESS = process.env.REACT_APP_ENTROPY_NFT_ADDRESS || '0x3bDB10e1D6c393186A40b1023B488Bfc1E549F41';
