 ...
 * @notice Example contract for generating random numbers using EntropyOracle
 * @dev Demonstrates how to request entropy and use it for random number generation
 */
