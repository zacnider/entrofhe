...
/**
 * @title EntropyNFT
 * @notice Real ERC721 NFT contract with trait selection using EntropyOracle
 * @dev Uses encrypted entropy to randomly select traits and stores metadata on IPFS
 */
