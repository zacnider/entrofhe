...
const ExampleTutorials: React.FC = () => {
  ...
  const examples = [
    ...
    { id: 'encryption-encryptmultiple', name: 'EntropyEncryptMultiple', category: 'Encryption' },
    { id: 'user-decryption-userdecryptsingle', name: 'EntropyUserDecryption', category: 'Decryption' },
    { id: 'user-decryption-userdecryptmultiple', name: 'EntropyUserDecryptMultiple', category: 'Decryption' },
    { id: 'public-decryption-publicdecryptsingle', name: 'EntropyPublicDecryption', category: 'Decryption' },
    { id: 'public-decryption-publicdecryptmultiple', name: 'EntropyPublicDecryptMultiple', category: 'Decryption' },
